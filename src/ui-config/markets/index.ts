...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x9aa4495177361a301BCAE9f14Aa032188f795fdE'.toLowerCase(),
      LENDING_POOL: '0x448e4BB597b543eA9CC2fe7983E0f1F7F95329be',
      WETH_GATEWAY: '0xE186945c78660789013AC8Ff5cCD2Ac72fb0Fca9',
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x011BD08279f4f6AB35C730e76e90bC0e0ACEaA5c'.toLowerCase(),
      LENDING_POOL: '0x11Aa78B1f440B553E5AF9e09D120c857279D922b',
      WETH_GATEWAY: '0x9302cB07E762601d0e0E3218f31450e83D6b4f80',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
