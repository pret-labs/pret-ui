...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x717716B4e4289F16B1AFEa33be8a714890b9384c'.toLowerCase(),
      LENDING_POOL: '0xbBe261850539234f669e68a3fAdEEA5383D86F50',
      WETH_GATEWAY: '0xC0f644af11318818B379cdbA5E101528Df0B4d6a',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
