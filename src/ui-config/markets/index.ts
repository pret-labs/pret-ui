...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xC6DD6f773b807F65aF7f815c77Ed0fD9114087cA'.toLowerCase(),
      LENDING_POOL: '0x7fDd8008Dca30112Abaa2371D090a128f4EeA886',
      WETH_GATEWAY: '0xe0a4E1117FB4C690195f8dbe0Cf497af8F3bCE08',
