...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xb1d9493Ec21508F5defcA194715049C3CcF5A402'.toLowerCase(),
      LENDING_POOL: '0xeaEFCe9344f26175731d1Dd900ADecD1f619416D',
      WETH_GATEWAY: '0xE4D133D123f605E6d78c4de5213D54860a7A8868',
