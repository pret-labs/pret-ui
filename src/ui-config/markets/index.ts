...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xca64974D033e001BEF46586500169700831997bD'.toLowerCase(),
      LENDING_POOL: '0x0c5610437F76E6A0558eb1bBc82EAAe103e3B2d4',
      WETH_GATEWAY: '0xC782140C0662306Cac0d05B5C48bCd5F947D90C9',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
