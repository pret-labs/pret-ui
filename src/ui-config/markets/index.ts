...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x7419a4A058E777c51CdE3091e9aE32071D911013'.toLowerCase(),
      LENDING_POOL: '0xc7132a2D4097945b6c3030C4c29eFf6E27E689B9',
      WETH_GATEWAY: '0x89b657B3F53ae6a147e85AF66428C6D3925CfB4A',
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x8bc790a583789367f72C9C59678ff85A00A5E5d0'.toLowerCase(),
      LENDING_POOL: '0xdc2D3D92F8a89956FB97d9e7b83032BD35b78EF7',
      WETH_GATEWAY: '0xFaCbFfa7A1D8f2892476A41122042218c194Ec81',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
