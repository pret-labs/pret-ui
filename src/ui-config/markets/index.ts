...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x94771b93cA9dC90Ae4C460f712a17703e8F036b6'.toLowerCase(),
      LENDING_POOL: '0xBCD1eD49e7F281C678c9620A372aD523f31d6073',
      WETH_GATEWAY: '0xb739Fd7b21ca5F30805B9c84241d6c2E621f4078',
