...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xbd7b1eaaBC5d621059dFa7a91661AD5F48fe8791'.toLowerCase(),
      LENDING_POOL: '0x4Bb99FB3219f946b723AEce657a968343bD36eef',
      WETH_GATEWAY: '0x44E9A61b882ddDa8bf2cBf03A650D375f2772833',
