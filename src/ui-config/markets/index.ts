...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xDa975e6Afb12D87b561406b82B75a29E44A8ec33'.toLowerCase(),
      LENDING_POOL: '0xF7C50B8972FB57264F0269368420210Ea45e709A',
      WETH_GATEWAY: '0x4B758B0129ed00B3bE3a6667A8A975a0a58ff8Db',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
    cornRewards: {
      [CORNRewardsAssets.WNEAR]: {
