...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xB929247352626f994f8368E5C37dc279de2415Dc'.toLowerCase(),
      LENDING_POOL: '0x405BBf7261668D06dAB3c75eFF25d65F62E3c011',
      WETH_GATEWAY: '0x675b105f42e764817bAE1c274380C55ec61FC200',
