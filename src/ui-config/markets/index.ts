...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xD0707aA96EdbeDb1Eb83e6a53985B5a1d263F8ab'.toLowerCase(),
      LENDING_POOL: '0xA46bC3B4FA363754F678F3c94b865bab91B6c725',
      WETH_GATEWAY: '0xbe85e75e5b0739dc86546A6a90440744CDf39Df4',
