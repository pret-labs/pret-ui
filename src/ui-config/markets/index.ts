...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x943DC1C1Df7d05a07F4b6CD00E64c45AAf17C511'.toLowerCase(),
      LENDING_POOL: '0xb979368bEB4dBaf559Ec484ef63D49E150dFb90C',
      WETH_GATEWAY: '0x407C5dF71D809C150fD890a199AdF5a2D17FaCF4',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
