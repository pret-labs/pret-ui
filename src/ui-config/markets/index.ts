...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x5355b6Cadb4F18e2C3601CbAa758F94d40aEFAA6'.toLowerCase(),
      LENDING_POOL: '0x049C4698c2A3E7E3C9601F97726891b64dF2F851',
      WETH_GATEWAY: '0x35Dd3f04f1C329a2b6cf60f2E752cd6d1933C2D7',
