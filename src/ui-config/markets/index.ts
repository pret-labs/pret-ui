...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xeb0e65E36D8369057233319A36f87A74b3d115FC'.toLowerCase(),
      LENDING_POOL: '0xC660f022777012fC33882a4630aa1e2abf2066c6',
      WETH_GATEWAY: '0x4AD2ECa724Aaf7F62A094B5b078a473592F984F0',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
