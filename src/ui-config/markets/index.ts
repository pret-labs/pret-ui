...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x448C67BDEd7F26369FE8cD845dec7F6eD27CFE04'.toLowerCase(),
      LENDING_POOL: '0xcDd29334a159d4aeA71e6fd3547551977dcAda09',
      WETH_GATEWAY: '0xcBcd9422d6ddDd4F337a08144C138fe18e8d371B',
