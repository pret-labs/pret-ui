...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_aurora_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x6dF6aC8322D0D2Ac2AA00b71c3D8b4fc6e2F71f2'.toLowerCase(),
      LENDING_POOL: '0xa0bC830Ad82D2EAe0bCFd1D6987664A3D9264aFA',
      WETH_GATEWAY: '0x10F1CA0b3Ea658433d291559093568dB0E4AEa07',
      // SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
