...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xC0D0bf6E511aCa3448eAe752C0470e16396D050e'.toLowerCase(),
      LENDING_POOL: '0x89861572827d1fA270e6691298779f76943C9B27',
      WETH_GATEWAY: '0x1545653289661f1BCE90E33C331dE8254592820d',
