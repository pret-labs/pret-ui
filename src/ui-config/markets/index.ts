...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_hardhat]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x0252D6d0495C9b2621449e92006F003E8F0546FE'.toLowerCase(),
      LENDING_POOL: '0xe2541D40bB2143bf2AB8Fac411518F87E29daA49',
      WETH_GATEWAY: '0x9218BBF266Bfd3C256dF0Dbb622ae84898E6448D',
